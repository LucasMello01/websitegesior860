...
<TABLE BORDER=0 CELLSPACING=1 CELLPADDING=4 WIDTH=100%> 
				...
				<TR BGCOLOR=#D4C0A1>
					...
					<TD><input type="radio" name="method" value="3"> Bradesco - Depósitos/DOCS/Transferencias Bancárias</TD>
				</TR>
								<TR BGCOLOR="#505050"> 
				<TR BGCOLOR=#D4C0A1>
 
												<TD><input type="radio" name="method" value="4" checked="checked"> Onebip - Crédito de celular/SMS</TD>
				</TR>
			</TABLE>
...
<input type="hidden" name="ref_transacao" value="'.$account_logged->getCustomField("name").'-pontos">
...
<div id="BackgroundContainerCenterImage" style="background-image: url(layouts/tibiacom/images/content/stonebar-center.gif);"></div>     
 ...
 <img class="Tube" src="layouts/tibiacom/images/vips/progress-bar-tube-blue.gif">          </div>          <div class="SingleStepContainer">      
 <img class="StepIcon" src="layouts/tibiacom/images/vips/progress-bar-icon-4-blue.gif">            <div class="StepText" style="font-weight: normal;">Pedido Realizado</div>   
 </div>        </div>      </div>    </div>  </div></div>Aqui você encontra tudo que é necessario para fazer sua doação com segurança e facilidade.<br><br>
...
</tbody></table></form>Lembrando que doando pelo PagSeguro, você não precisa confirmar seu pagamento, assim que PagSeguro aprovar os seus pontos, serão adicionados em sua conta <u>automaticamente</u> pelo nosso sistema.</TD></TR>
