...
<table border="0">         
		...
		<td style="text-align: center; font-weight: bold;"> 
                                        <center><font color="white">Most powerfull guilds</font></center>
                                </td> 
                        </tr> 
                </table> 
        </div> 
...
foreach ($zapytanie as $row)
{
		...
		{
			$main_content .='<td width="100%">'.$message.'<br><h6><i>Posted by </i><font color="green">'.$row['name'].'</font></h6><p align="right"><a href="?subtopic=forum&action=show_thread&id='.$row['id'].'"> >> Comment on this news: '.$row['replies'].'</a></p>';		
		}
		$main_content .= '</td>
		<td><img src="'.$layout_name.'/images/global/general/blank.gif" width=10 height=1 border=0 alt=\'\' /></td>
		</tr></table>';
