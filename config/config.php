...
//Others
$config['site']['otslist.eu'] = 8249; //server id in otslist.eu to show Players Online Chart (whoisonline.php)
$config['site']['quests'] = array('Annihilator' => 5010,'Demon Helmet' => 50025,'Pits of Inferno' => 10547); // list of quests, 'questname' => storage-id,
...
$config['site']['mail_address'] = "punchemails@googlemail.com"; // e-mail address
...
$config['site']['smtp_user'] = "punchemails@googlemail.com"; // login
...
$config['site']['players_group_id_block'] = 5; // don't show in statistics players with group ID higher (or equal) then (show tutors, senior tutors and normal players)
$config['site']['support_group_id'] = 4; // on game Vips list show players with group id 2 or higher
