...
function LoadLoginBox()
{
  if(loginStatus == "false") {
    ...
    document.getElementById('LoginstatusText_1').style.backgroundImage = "url('" + IMAGES + "/loginbox/loginbox-font-create-account.gif')";
    ...
    document.getElementById('LoginstatusText_1').style.backgroundImage = "url('" + IMAGES + "/loginbox/loginbox-font-logout.gif')";
...
function LoadMenu()
{
  ...
  if(self.name.lastIndexOf("&") == -1) {
    self.name = "news=1&account=0&community=0&forum=0&library=0&wars=0&system=0&events=0&shops=0&";
  }
  FillMenuArray();
  InitializeMenu();
}
